...
Hook.create(
    ...
    description: "Your loathsome stepfamily has gone out for ice cream and left you with a laundry-list of tasks. You get on your hands and knees and start rubbing and scrubbing. But what's this? An envelope jammed in a doorhinge? Who's this for? <br> <h3> Dearest <%= @character.name %>, after a rigorous Google search process for alienated orphans in our area, <b>YOU</b> have been selected to attend the Urban Fantasy School of Tropes and Eurowizardry. Pack your meager belongings, you start today! </h3> <br> Wow! Just the sort of escape hatch from reality you'd been pining for! <br><br> Congratulations, you've become a <b>Student at a Wizard School.</b>", 
